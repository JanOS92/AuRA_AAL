            ...
            if (dataArrived1 || dataArrived2) {
                ...
                if (field1.cols != fieldWidth || field1.rows != fieldHeight ||
                    ...
                    ROS_WARN_STREAM(ros::this_node::getName()
                                            << " insufficient field size: (field1.cols, field1.rows, field2.cols, field2.rows, fieldWidth, fieldHeight)=("
                                            <<
                                            field1.cols << ", " << field1.rows << ", " << field2.cols << ", "
                                            << field2.rows << ", " << fieldWidth << ", " << fieldHeight << ")");
                    continue;
