// ============================================================================
// Name        : image_to_vectorfield_charge_node.cpp
// Author      : Daniel Rudolph <drudolph@techfak.uni-bielefeld.de>
//               Timo Korthals <tkorthals@cit-ec.uni-bielefeld.de>
// Description : Receive a image and creates a charge vectorfield.
// ============================================================================
...
static float heuristic_abs_min = 0.5f;
...
//    node.param<string>("image_listener_topic", rosListenerTopic, "/image");
    node.param<string>("image_listener_topic", rosListenerTopic, "/image/image_charge");
...
//    node.param<string>("vectorfield_publisher_topic", rosPublisherTopicVec, "/image/vectorfield");
    node.param<string>("vectorfield_publisher_topic", rosPublisherTopicVec, "/vectorfield/final_image_charge");
