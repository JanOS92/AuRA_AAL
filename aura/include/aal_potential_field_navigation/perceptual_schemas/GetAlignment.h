 ...
 * ==============================================================================
 * \file GetAlignment.h
 * \brief Provides the declaration of the perceptual schema class GetAlignment
 * \author Jan O'Sullivan <josullivan@techfak.uni-bielefeld.de>
 * ==============================================================================  */

#ifndef AAL_POTENTIAL_FIELD_NAVIGATION_GETALIGNMENT_H
#define AAL_POTENTIAL_FIELD_NAVIGATION_GETALIGNMENT_H
...
class GetAlignment : public PerceptualSchema {
...
public:
    ...
    bool getPerceptualData_b(cv::Mat &vectorfield, uint64_t targetRFID_ui, uint64_t currentRFID_ui, uint64_t lastRFID_ui,
...
#endif //AAL_POTENTIAL_FIELD_NAVIGATION_GETALIGNMENT_H
